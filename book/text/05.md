...
|  **Figure 11.** Share of electricity generated from base load, mid load, and peak load plants without renewables and at 40% penetration. |   **Figure 12.** Share of electricity generated from base load plants (defined as 8,000+ FLH) for different rates of wind plus solar penetration.    |
|---|---|
| **Key point:** As penetration of renewables increases, less electricity should be generated using base load plants and more using mid and peak load plants.  |  **Key point:** Base load disappears as renewable energy expands. |
| ![Share of electricity generated from base load, mid load, and peak load plants without renewables and at 40% penetration](../images/chapter5/chapter5_figure11.png)  |  ![Share of electricity generated from base load plants (defined as 8,000+ FLH) for different rates of wind plus solar penetration](../images/chapter5/chapter5_figure12.png) |
...
**Source:** OEE, adopted from [Green (2005)](https://doi.org/10.1093/oxrep/gri004)
